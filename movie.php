...
if (!empty($userData)) {
    ...
    $alreadyReviewd = $reviewDao->hasAlreadyReviewid($id, $userData->id);
}
...
<div id="main-container" class="container-fluid">
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <!-- Verifica se habilita a review da página pro usuário ou não -->
            <?php if (!empty($userData) && !$userOwnsMovie && !$alreadyReviewd) : ?>

                <div class="col-md-12" id="review-form-container">
                    <h4>Envie sua avaliação</h4>
                    <p class="page-description">Preencha o formulário com a nota e a sua opinião sobre o filme</p>
